...
//files defined by devkit developer
#include "mail.h"
#include "io_disp.h"
#include "io_flow.h"
...
#define NUM_TEST_IMAGES 446
#define NUM_ERROR_IMAGES 446
...
bool eval (string result_sha,Mail* mail) {
  ...
  string gt_img_dir = "/home/sushlok/new_approach/datasets/vkitti/vkitti_1.3.1_rgb/0001/" + result_sha ;
  string gt_obj_map_dir = "/home/sushlok/new_approach/datasets/vkitti/vkitti_1.3.1_rgb/0001/" + result_sha ;
  ...
  string gt_flow_noc_dir = "/home/sushlok/new_approach/datasets/vkitti/vkitti_1.3.1_flowgt/0001/" + result_sha;
  string gt_flow_occ_dir = "/home/sushlok/new_approach/datasets/vkitti/vkitti_1.3.1_flowgt/0001/" + result_sha;
  string result_dir = "/home/sushlok/optical_flow/GMFlowNet/result/vkitti_" + result_sha;
  ...
  cout << "result_flow_dir: " << result_flow_dir << endl;
