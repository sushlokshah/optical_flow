...
if __name__ == "__main__":
    ...
    # "maskflownet_final",
    # "maskflownet_ft_flying_chair_Fast_features_30",
    # "maskflownet_final_Fast_features_10",
    # "maskflownet_ft_flying_chair_Fast_features_60",
    # "maskflownet_final_Fast_features_30",
    # "maskflownet_ft_flying_chair_GoodFeaturesToTrack",
    # "maskflownet_final_Fast_features_60",     
    # "maskflownet_final_GoodFeaturesToTrack",  
    # "maskflownet_ft_flying_chair",                      
    # "maskflownet_ft_flying_chair_Fast_features_10",
    # "raft_kitti",
    # "raft_mixed_data_Fast_features_30",
    # "raft_kitti_Fast_features_10",
    # "raft_mixed_data_Fast_features_60",
    # "raft_kitti_Fast_features_30",
    # "raft_mixed_data_GoodFeaturesToTrack",
    # "raft_kitti_Fast_features_60",     
    # "raft_kitti_GoodFeaturesToTrack",  
    # "raft_mixed_data",                      
    # "raft_mixed_data_Fast_features_10"
    "gma_kitti",                           
    "gma_plus_kitti_Fast_features_10",          
    "gma_p_only_kitti_Fast_features_30",
    "gmflownet_kitti_Fast_features_60",
    "gma_kitti_Fast_features_10",          
    "gma_plus_kitti_Fast_features_30",          
    "gma_p_only_kitti_Fast_features_60",          
    "gmflownet_kitti_GoodFeaturesToTrack",
    "gma_kitti_Fast_features_30",
    "gma_plus_kitti_Fast_features_60",         
    "gma_p_only_kitti_GoodFeaturesToTrack",
    "gmflownet_mixed",
    "gma_kitti_Fast_features_60",        
    "gma_plus_kitti_GoodFeaturesToTrack",
    "gma_p_only_mixed_data",
    "gmflownet_mixed_Fast_features_10",
    "gma_kitti_GoodFeaturesToTrack",       
    "gma_plus_mixed_data",                      
    "gma_p_only_mixed_data_Fast_features_10",     
    "gmflownet_mixed_Fast_features_30",
    "gma_mixed_data",                      
    "gma_plus_mixed_data_Fast_features_10",     
    "gma_p_only_mixed_data_Fast_features_30",
    "gmflownet_mixed_Fast_features_60",
    "gma_mixed_data_Fast_features_10",     
    "gma_plus_mixed_data_Fast_features_30",     
    "gma_p_only_mixed_data_Fast_features_60",     
    "gmflownet_mixed_GoodFeaturesToTrack",
    "gma_mixed_data_Fast_features_30",     
    "gma_plus_mixed_data_Fast_features_60",     
    "gma_p_only_mixed_data_GoodFeaturesToTrack",
    "gma_mixed_data_Fast_features_60",
    "gma_plus_mixed_data_GoodFeaturesToTrack",
    "gmflownet_kitti",
    "gma_mixed_data_GoodFeaturesToTrack",
    "gma_p_only_kitti",
    "gmflownet_kitti_Fast_features_10",
    "gma_plus_kitti",                      
    "gma_p_only_kitti_Fast_features_10",        
    "gmflownet_kitti_Fast_features_30"
    ]
